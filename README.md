...
- An **Anthropic API key** — from [console.anthropic.com](https://console.anthropic.com), or an **OpenAI API key** — from [platform.openrouter.com](https://openrouter.ai)
...
#define MIMI_SECRET_MODEL_PROVIDER  "anthropic"     // "anthropic" or "openrouter"
...
mimi> set_api_key sk-ant-api03-... # change API key (Anthropic or openrouter)
mimi> set_model_provider openrouter    # switch provider (anthropic|openrouter)
